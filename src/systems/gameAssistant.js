(() => {
  ...
  const KNOWLEDGE_BASE = [
    ...
    },
    {
      ...
      answer: 'В воздушном измерении высоко в небе расположены облачные острова, а внизу находится пустота. На стартовом облаке стоят домики ветренных, а дальше можно добраться до Замка воздушного короля.',
    },
    {
